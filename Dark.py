...
| $$        /$$/    | $$  \ $$  \  $$$/  | $$      | $$      | $$ \ $$$| $$ \ $$$  /$$/    
| $$       /$$/     | $$  | $$   \  $/   | $$$$$$$$| $$$$$$$$|  $$$$$$/|  $$$$$$/ /$$/     
|__/      |__/      |__/  |__/    \_/    |________/|________/ \______/  \______/ |__/      
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[AUTHOR                   • \33[1;38mMR PARVEZ ]\33[1;38m     ║\033[1;31m 
╠══[FACEBOOK                 • MR UNKNOWN ]   ║  \033[1;97m  
╠══[GITHUB                   • \33[1;38mP7RVE2007 ]   ║\33[1;34m   
...
def Main():
        ...
        if Alhaj in ["1","01"]:
            sexy()
        if Alhaj in ["2","02"]:
        	os.system('xdg-open t.me/unknownmrparvez')
        if Alhaj in [" 0", "00"]:
            exit()
        else:
            exit()     
